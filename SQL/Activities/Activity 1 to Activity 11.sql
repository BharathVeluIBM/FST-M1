...
SELECT distinct a.* FROM salesman a WHERE salesman_city='Paris';
...
UPDATE salesman SET grade=200 WHERE salesman_city='Rome'; commit;
...
SELECT grade, COUNT(*) FROM customers 
GROUP BY grade HAVING grade>(SELECT AVG(grade) FROM customers WHERE salesman_city='Paris');
